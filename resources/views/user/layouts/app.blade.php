                ...
                <div id="main-nav" class="w-1/2 md:w-1/3 lg:w-64 fixed mt-20 md:mt-0 md:top-0 md:left-0 h-screen bg-gray-50 z-30 overlay transform transition duration-500 -translate-x-full">
                    ...
                    <div class="flex flex-col mb-8 px-4 gap-y-2">
                        ...
                        @if(Auth::user()->role == 'user')
                            <a href="{{ route('datadiri.index')}}" class="w-full flex items-center text-blue-500 h-10 pl-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                 <span class="text-gray-700">User</span>
                            </a>
                            <a href="{{ route('biodata.index')}}" class="w-full flex items-center text-blue-500 h-10 pl-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                                 <span class="text-gray-700">Biodata</span>
                            </a>
                            <a href="{{ route('prestasiwarga.index')}}" class="w-full flex items-center text-blue-500 h-10 pl-4 ">
